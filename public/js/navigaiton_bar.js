...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const searchButton = document.querySelector('#top_menu nav form .form-input button');
    ...
    menuBar.addEventListener('click', function () {
        ...
        windowLayout.classList.toggle('window-closed', sidebar.classList.contains('hide'));
    });
    ...
    searchButton.addEventListener('click', function (e) {
        if (window.innerWidth < 576) {
            ...
            searchButtonIcon.classList.replace('bx-search', searchForm.classList.contains('show') ? 'bx-x' : 'bx-search');
        }
    });
