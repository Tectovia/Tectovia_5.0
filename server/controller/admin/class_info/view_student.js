...
exports.view_parent= async (req,res)=>{
  ...
  const data=await model.findOne({_id:_id},{id:1,father_img:1,mother_img:1,guardian_img:1,father_name:1,parent_whatsapp:1,mother_name:1,father_aadhar:1,mother_aadhar:1,father_occupation:1 ,mother_occupation:1,father_voter:1, mother_voter:1,guardian_address:1,guardian_whatsapp:1,guardian_alter:1,guardian_name:1,guardian_phone1:1,guardian_phone2:1,income_cer:1, parent_phone1:1, parent_phone2:1,guardian_address:1, parent_alter:1,parent_annual:1})
  console.log(data);
